...
__help__ = """WelfareFunding setup script :
setup : Install dependencies of Gaimon.
install : Install WelfareFunding into machine.
...
class WelfareFundingSetup :
	def __init__(self) :
		...
		self.installPathList = [
			(f"{self.rootPath}/welfarefunding", f"{self.sitePackagesPath}/welfarefunding"),
		]
